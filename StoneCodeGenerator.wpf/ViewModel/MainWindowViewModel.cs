...
{
    class MainWindowViewModel : CommunityToolkit.Mvvm.ComponentModel.ObservableObject
    {
        ...
        private ObservableCollection<DemoDataModel> GetDataList()
        {
            ...
            {
                new DemoDataModel{ ImgPath = "pack://application:,,,/Resource/Image/LeftMainContent/Brush_16x.png", Name = "生成方法"},
